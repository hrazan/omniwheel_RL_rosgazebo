...
if __name__ == '__main__':
    ...
    if not continue_execution:
        ...
        with open(params_json) as outfile:
            ...
            MEMORIES = pd.read_csv('/home/katolab/experiment_data/AC_data_3/experience.csv', index_col=0, dtype = {'reward':np.float64, 'done':np.float32})
    ...
    for episode in xrange(CURRENT_EPISODE+1, EPISODES+1, 1):
        ...
        if (episode)%100==0:            
            ...
            actor_critic.replay_memory.exp.to_csv('/home/katolab/experiment_data/AC_data_3/experience.csv')
